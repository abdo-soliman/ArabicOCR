...
def charToFeatureVector(char):
    ...
    horizontal_end = horizontal_start + char.shape[1]

    mask[vertical_start:vertical_end,
         horizontal_start:horizontal_end] = char
